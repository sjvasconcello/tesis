...
En cuanto a la creación del backend, se desarrollo una API con el objetivo de facilitar la interacción entre el frontend y el backend, aumentando así la velocidad
