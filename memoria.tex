...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\dedicatoria{%
    \emph{\huge A todos los que estuvieron conmigo en las buenas y en las malas, mi familia, mis amigas y amigos. Y para ti también, para mi hoy me titulo por los dos \dots}
...
\input{includes/001_introduccion.tex}

\input{includes/002_estado_del_arte.tex}

\input{includes/003_creacion_del_proyecto.tex}

\input{includes/004_ejemplo.tex}

\input{includes/005_riego.tex}

\input{includes/006_conclusion.tex}

\input{includes/007_recomendacones.tex}
